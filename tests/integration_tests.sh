...
wget -q --show-progress https://www.nuscenes.org/data/v1.0-mini.tgz -O /tmp/nuscenes/nuscenes_v1.0-mini.tgz
tar -xzf /tmp/nuscenes/nuscenes_v1.0-mini.tgz -C /tmp/nuscenes

# Prepare /tmpm/argoverse2_small/val
...
wget -q https://github.com/kylevedder/BucketedSceneFlowEval/files/14668631/argove07.zip -O /tmp/argoverse_small_part_07.zip
...
wget -q https://github.com/kylevedder/BucketedSceneFlowEval/files/14668653/argove12.zip -O /tmp/argoverse_small_part_12.zip
wget -q https://github.com/kylevedder/BucketedSceneFlowEval/files/14668653/argove12.zip -O /tmp/argoverse_small_part_12.zip
